...
const slides = [
{
  city: 'CHIẾN LƯỢC ĐỨNG TRÊN VAI NGƯỜI KHỔNG LỒ',
...
{
  city: 'KHÓA HỌC 09 BÍ QUYẾT ĐỌC VỊ DOANH NGHIỆP',
...
{
  city: 'ĐỌC VỊ CỔ PHIẾU CHUYÊN SÂU',
...
{
  city: 'ĐỊNH GIÁ CỔ PHIẾU CAO CẤP',
